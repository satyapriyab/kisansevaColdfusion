...
<script>
  ...
  <script src="../../assets/template/plugins/jQuery/jquery-2.2.3.min.js"></script>
  <script type="text/javascript" src="../../assets/custom/js/script.js?ver=1.4.11"></script>
  <script type="text/javascript" src="../../assets/template/dist/js/jquery-1.11.2.min.js"></script>
  <script type="text/javascript" src="../../assets/template/dist/js/bootstrap-table.js"></script>
  <script type="text/javascript" src="../../assets/template/dist/js/tableScript.js?ver=1.7">
  </script>
<script src="../../assets/template/plugins/sparkline/jquery.sparkline.min.js"></script>
...
<script src="../../assets/template/plugins/knob/jquery.knob.js"></script>

<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="../../assets/template/plugins/daterangepicker/daterangepicker.js"></script>

<script src="../../assets/template/plugins/datepicker/bootstrap-datepicker.js"></script>
